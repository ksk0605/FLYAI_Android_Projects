package com.flyai.android_dbsqlite1;
...
public class MainActivity extends AppCompatActivity {
    ...
    SQLiteDatabase myDB; // SQLite DB
    SimpleAdapter myADT; // Adapter
    ArrayList<String> aryMBRList; // MemberRecordList
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Store My Data("Kim Sung Kyum", "010-1111-2222") to members table by query
        myDB.execSQL("Insert into members " + "(Name, Phone_No) values ('Kim Sung Kyum', '010-1111-2222');");

        //Store My Data("Kim Sung Kyum", "010-1111-2222") to members table by ContentValues
